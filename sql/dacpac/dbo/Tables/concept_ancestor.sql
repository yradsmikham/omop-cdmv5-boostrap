CREATE TABLE [dbo].[concept_ancestor] (
    ...
    CONSTRAINT [fpk_concept_ancestor_concept_1] FOREIGN KEY ([ancestor_concept_id]) REFERENCES [dbo].[concept] ([concept_id]),
    CONSTRAINT [fpk_concept_ancestor_concept_2] FOREIGN KEY ([descendant_concept_id]) REFERENCES [dbo].[concept] ([concept_id])
);
