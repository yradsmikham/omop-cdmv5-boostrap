CREATE TABLE [dbo].[concept_relationship] (
    ...
    CONSTRAINT [fpk_concept_relationship_c_1] FOREIGN KEY ([concept_id_1]) REFERENCES [dbo].[concept] ([concept_id]),
    CONSTRAINT [fpk_concept_relationship_c_2] FOREIGN KEY ([concept_id_2]) REFERENCES [dbo].[concept] ([concept_id]),
